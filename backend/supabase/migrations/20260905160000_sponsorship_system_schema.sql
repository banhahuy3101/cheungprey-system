...
CREATE TABLE IF NOT EXISTS public.sponsorship_items (
    ...
    item_qty NUMERIC(15, 2) NOT NULL DEFAULT 1,
    item_unit VARCHAR(100) NOT NULL DEFAULT 'គ.ក',
    cash_allocation_usd NUMERIC(15, 2) DEFAULT 0.00,
    cash_allocation_khr BIGINT DEFAULT 0,
    usage_description TEXT,
    remarks TEXT,
    item_notes TEXT,
    created_at TIMESTAMPTZ DEFAULT NOW()
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'sponsorship_records' AND policyname = 'Allow authenticated read sponsorship_records'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'sponsorship_records' AND policyname = 'Allow authenticated insert sponsorship_records'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'sponsorship_records' AND policyname = 'Allow authenticated update sponsorship_records'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'sponsorship_records' AND policyname = 'Allow authenticated delete sponsorship_records'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'sponsorship_items' AND policyname = 'Allow authenticated read sponsorship_items'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'sponsorship_items' AND policyname = 'Allow authenticated insert sponsorship_items'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'sponsorship_items' AND policyname = 'Allow authenticated update sponsorship_items'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'sponsorship_items' AND policyname = 'Allow authenticated delete sponsorship_items'
    ) THEN
