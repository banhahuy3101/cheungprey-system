...
import { LuPlus, LuTrash2, LuDownload, LuSearch, LuX } from "react-icons/lu";
                    ...
                    <tr key={f.id}>
                      ...
                      <td>
                        <div className="actions">
                          {f.url && (
                            <a href={f.url} target="_blank" rel="noopener noreferrer" className="btn-icon" title="ទាញយក">
                              <LuDownload />
                            </a>
                          )}
